var Penta = {
    ...
    Start: function(){
        ...
        if(self._clef >= 2 && self._clef <= 5){
            $('#logo_do').css('display', 'block');
            $('#clef_line').html($('#clef_do_name').val()+' '+(self._clef - 1)+'&ordf; '+$('#clef_line_name').val());
        }
        
        if(self._clef == 6 || self._clef == 7){
            $('#logo_fa').css('display', 'block');
            $('#clef_line').html($('#clef_fa_name').val()+' '+(self._clef - 3)+'&ordf; '+$('#clef_line_name').val());
        }         
